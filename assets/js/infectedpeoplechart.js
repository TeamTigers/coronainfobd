    ...
    data: [
      {
        ...
        indexLabel: "{name} - {y}",
        dataPoints: [
          { y: 419, name: "Dhaka", exploded: true },
          { y: 25, name: "Chattagram" },
          { y: 9, name: "Rangpur" },
          { y: 11, name: "Mymensingh" },
          { y: 3, name: "Sylhet" },
          { y: 2, name: "Barishal" },
          { y: 1, name: "Khulna" },
        ],
    ...
    data: [
      {
        ...
        axisYType: "secondary",
        dataPoints: [
          { y: 251, label: "Dhaka City" },
          { y: 18, label: "Dhaka(District)" },
          { y: 12, label: "Gazipur" },
          { y: 3, label: "Jamalpur" },
          { y: 10, label: "Kishoreganj" },
          { y: 13, label: "Madaripur" },
          { y: 5, label: "Manikganj" },
          ...
          { y: 2, label: "Gpalganj" },
          { y: 1, label: "Keraniganj" },
          { y: 8, label: "Chattagram" },
